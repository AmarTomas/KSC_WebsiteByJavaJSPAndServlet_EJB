...
<html>
 ...
 <img src="data:image/jpeg;base64,<%= card.getImage() %>"  style="width: 100%;height: 350px" alt="<%= card.getName() %>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <form id="form" action="../np/DeleteRegistrationServlet" method="post">
                                <input type="hidden" name="activityId" value="<%= cardId%>"> <!-- Replace with the actual activity ID -->
                                <button style="color: white ;background-color: salmon;border: white;border-radius: 10px;margin: 10px;padding: 10px">Unregistration</button>
                       </form> </div>
                    </div>
                </div>
